...
export interface AnimatedAIChatProps {
  ...
  /** When true, skip the colored blur blobs + mouse-tracking glow so the surface stays one solid shade. */
  quiet?: boolean;
}
...
const DEFAULT_SUGGESTIONS: CommandSuggestion[] = [
  {
    ...
    description: "Quote homeowner coverage",
    prefix: "/home",
  },
  {
    icon: <Figma className="w-4 h-4" />,
    label: "Renters",
    description: "Quote renters coverage",
    prefix: "/renters",
  },
  {
    icon: <MonitorIcon className="w-4 h-4" />,
    label: "Mortgage",
    description: "Find a mortgage",
    prefix: "/mortgage",
  },
  {
...
export function AnimatedAIChat({
  ...
  title = "How can Alto help today?",
  subtitle = "Type a command or describe what you need",
  ...
  useEffect(() => {
    if (value.startsWith("/") && !value.includes(" ")) {
      ...
      setActiveSuggestion(matchingIndex);
    } else {
    ...
    <div className="flex flex-col w-full items-center justify-center bg-transparent text-white relative">
      {!quiet && (
        <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none">
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-sky-500/15 rounded-full filter blur-[128px] animate-pulse" />
          <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-blue-500/15 rounded-full filter blur-[128px] animate-pulse delay-700" />
      ...
      <div className="w-full max-w-2xl mx-auto relative">
        ...
        >
          <div className="text-center space-y-3">
            ...
            >
              <h1 className="text-3xl md:text-4xl font-medium tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white/95 to-white/50 pb-1">
                {title}
              </h1>
              <motion.div
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-8 h-7 rounded-full bg-white/[0.05] flex items-center justify-center">
                <span className="text-xs font-medium text-white/90">Alto</span>
              </div>
      ...
      {!quiet && inputFocused && (
        <motion.div
          className="fixed w-[50rem] h-[50rem] rounded-full pointer-events-none z-0 opacity-[0.03] bg-gradient-to-r from-sky-500 via-blue-500 to-cyan-500 blur-[96px]"
          animate={{
