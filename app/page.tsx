  ...
  return (
    <main className="bg-[#050507] text-white">
        ...
        >
          <div className="h-full w-full bg-gradient-to-br from-[#0a0a14] to-[#0a1424] p-6 md:p-10 flex flex-col gap-4 overflow-hidden">
            <ChatBubble role="user">
              I&apos;m buying a home in Austin, $425k, need home insurance.
            ...
            <ChatBubble role="alto">
              Pulled live quotes for 78704. Lemonade is cheapest at $47/mo with
              solid claims. Progressive is $52/mo if you bundle auto.
              State Farm at $61/mo has the lowest deductible.
              <br />
              <br />
              My pick: Lemonade. You save $168/yr vs. State Farm and get instant
              app-based claims.
            </ChatBubble>
            <div className="grid grid-cols-3 gap-3 mt-2">
              <QuoteMini name="Lemonade" price={47} pick />
              <QuoteMini name="Progressive" price={52} />
              <QuoteMini name="State Farm" price={61} />
            </div>
          </div>
        </ContainerScroll>
      </section>
      ...
      <section className="bg-black border-t border-white/[0.05]">
        <div className="max-w-3xl mx-auto px-6 pt-24 text-center">
          ...
          <h2 className="mt-3 text-4xl md:text-5xl font-semibold tracking-tight">
            10,000+ have skipped the broker.
          </h2>
        </div>
      ...
      <footer className="bg-black px-6 py-12 text-center text-sm text-white/40 border-t border-white/[0.05]">
        Alto · {new Date().getFullYear()} · Built for the AI era of fintech.
      </footer>
    </main>
  );
}
